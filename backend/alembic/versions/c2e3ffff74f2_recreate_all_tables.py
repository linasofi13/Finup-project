...
def upgrade() -> None:
    ...
    op.alter_column('entorno', 'status',
...
def downgrade() -> None:
    ...
    op.alter_column('entorno', 'status',
               existing_type=sa.BOOLEAN(),
               nullable=False)
    op.create_table('technical_leaders',
    ...
    op.create_index('ix_technical_leaders_id', 'technical_leaders', ['id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['functional_leader_id'], ['functional_leader.id'], name='entornos_functional_leader_id_fkey'),
    sa.ForeignKeyConstraint(['technical_leader_id'], ['technical_leader.id'], name='entornos_technical_leader_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='entornos_pkey')
    )
    op.create_index('ix_entornos_id', 'entornos', ['id'], unique=False)
    op.create_table('functional_leaders',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('email', sa.VARCHAR(), autoincrement=False, nullable=False),
    ...
    op.create_index('ix_functional_leaders_id', 'functional_leaders', ['id'], unique=False)
