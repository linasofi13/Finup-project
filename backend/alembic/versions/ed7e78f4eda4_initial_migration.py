...
def upgrade() -> None:
    ...
    op.alter_column('app_user_category', 'app_user_id',
               existing_type=sa.INTEGER(),
               nullable=True)
    op.alter_column('app_user_category', 'category_id',
               existing_type=sa.INTEGER(),
               nullable=True)
    op.create_index(op.f('ix_app_user_category_app_user_category_id'), 'app_user_category', ['app_user_category_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_app_user_category_app_user_category_id'), table_name='app_user_category')
    op.alter_column('app_user_category', 'category_id',
               existing_type=sa.INTEGER(),
               nullable=False)
    op.alter_column('app_user_category', 'app_user_id',
    ...
    sa.Column('provider_id', sa.INTEGER(), server_default=sa.text("nextval('provider_provider_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.ForeignKeyConstraint(['category_provider_id'], ['category_provider.category_provider_id'], name='provider_category_provider_id_fkey'),
    sa.PrimaryKeyConstraint('provider_id', name='provider_pkey'),
    postgresql_ignore_search_path=False
    )
    op.create_table('evc',
    sa.Column('evc_id', sa.INTEGER(), server_default=sa.text("nextval('evc_evc_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(length=60), autoincrement=False, nullable=False),
    ...
    sa.ForeignKeyConstraint(['entorno_id'], ['entorno.entorno_id'], name='evc_entorno_id_fkey'),
    sa.ForeignKeyConstraint(['functional_leader_id'], ['functional_leader.functional_leader_id'], name='evc_functional_leader_id_fkey'),
    sa.ForeignKeyConstraint(['technical_leader_id'], ['technical_leader.technical_leader_id'], name='evc_technical_leader_id_fkey'),
    ...
    sa.ForeignKeyConstraint(['category_role_id'], ['category_role.category_role_id'], name='role_category_role_id_fkey'),
    sa.PrimaryKeyConstraint('role_id', name='role_pkey'),
    postgresql_ignore_search_path=False
    )
    op.create_table('category_role',
    sa.Column('category_role_id', sa.INTEGER(), server_default=sa.text("nextval('category_role_category_role_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(length=50), autoincrement=False, nullable=False),
    sa.PrimaryKeyConstraint('category_role_id', name='category_role_pkey'),
    postgresql_ignore_search_path=False
    )
    op.create_table('category_provider',
    sa.Column('category_provider_id', sa.INTEGER(), server_default=sa.text("nextval('category_provider_category_provider_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('evc_q_id', sa.INTEGER(), server_default=sa.text("nextval('evc_q_evc_q_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('entorno_id', sa.INTEGER(), server_default=sa.text("nextval('entorno_entorno_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(length=60), autoincrement=False, nullable=False),
    sa.Column('functional_leader_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('technical_leader_id', sa.INTEGER(), autoincrement=False, nullable=True),
    ...
    sa.Column('role_provider_id', sa.INTEGER(), server_default=sa.text("nextval('role_provider_role_provider_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.ForeignKeyConstraint(['country_id'], ['country.country_id'], name='role_provider_country_id_fkey'),
    sa.ForeignKeyConstraint(['provider_id'], ['provider.provider_id'], name='role_provider_provider_id_fkey'),
    sa.ForeignKeyConstraint(['role_id'], ['role.role_id'], name='role_provider_role_id_fkey'),
    ...
    sa.ForeignKeyConstraint(['evc_q_id'], ['evc_q.evc_q_id'], name='evc_financial_evc_q_id_fkey'),
    sa.ForeignKeyConstraint(['role_provider_id'], ['role_provider.role_provider_id'], name='evc_financial_role_provider_id_fkey'),
    ...
    sa.Column('technical_leader_id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(length=80), autoincrement=False, nullable=False),
    ...
    sa.Column('functional_leader_id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(length=80), autoincrement=False, nullable=False),
    sa.Column('email', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
