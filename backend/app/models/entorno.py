from sqlalchemy import Column, Integer, String, ForeignKey, Boolean, Date, func, DateTime
...
class Entorno(Base):
    ...
    updated_at=Column(DateTime, nullable=False, default=func.now(), onupdate=func.current_date())
