...
def upgrade() -> None:
    ...
    op.add_column('provider', sa.Column('category_provider_id', sa.Integer(), nullable=True))
    op.create_foreign_key(None, 'provider', 'category_provider', ['category_provider_id'], ['id'])
    op.drop_constraint('role_provider_provider_id_fkey', 'role_provider', type_='foreignkey')
...
def downgrade() -> None:
    ...
    op.create_foreign_key('role_provider_provider_id_fkey', 'role_provider', 'providers', ['provider_id'], ['id'])
