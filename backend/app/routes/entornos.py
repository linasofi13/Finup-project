...
def update_entorno(entorno_id: int, entorno_data: EntornoUpdate, db: Session = Depends(get_db)):
...
@router.delete("/entornos/{entorno_id}", response_model=EntornoResponse, tags=[tag_name])
