...
from app.schemas.evc_q import EVC_QCreate, EVC_QResponse, EVC_QUpdate, EVC_QShortResponse
...
async def update_evc_q(evc_q_id: int, evc_q_data: EVC_QUpdate, db: Session = Depends(get_db)):
