...
class EVCResponse(EVCBase):
    ...
    def get_technical_leader(self):
        if self.technical_leader_id:
            ...
            return technical_leader_service.get_technical_leader_by_id(
                self.technical_leader_id
            )
    ...
    def get_functional_leader(self):
        if self.functional_leader_id:
            ...
            return functional_leader_service.get_functional_leader_by_id(
                self.functional_leader_id
            )
