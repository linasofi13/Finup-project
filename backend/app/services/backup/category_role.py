...
# def update_category_role(
#     db: Session, category_role_id: int, category_role_data: CategoryRoleUpdate
# ):
...
#     db_category_role = (
#         db.query(CategoryRole).filter(CategoryRole.id == category_role_id).first()
#     )
#     if db_category_role:
