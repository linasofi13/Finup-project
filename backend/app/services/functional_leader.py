...
def create_functional_leader(db: Session, functional_leader_data: FunctionalLeaderCreate):
...
def update_functional_leader(db: Session, functional_leader_id: int, functional_leader_data: FunctionalLeaderUpdate):
