...
def sample_functional_leader(db_session: Session):
    ...
    new_leader = FunctionalLeader(name="Test FunctionalLeader", email="somemail@mail.com")
...
def test_get_functional_leader_by_name(sample_functional_leader, db_session: Session):
    ...
    functional_leader = get_functional_leader_by_name(db_session, "Test FunctionalLeader")
    
    assert functional_leader is not None, "Functional Leader was not found in the database!"
...
def test_get_functional_leader_by_id(sample_functional_leader, db_session: Session):
    ...
    functional_leader = get_functional_leader_by_id(db_session, sample_functional_leader.id)
