            ...
            <div className="flex-shrink-0 flex items-center">
              <Link href="/dashboard" className="flex items-center space-x-2 group">
                <div className="bg-bancolombia-yellow rounded-full p-1.5 transform transition-all duration-300 group-hover:scale-110">
                  <span className="text-xl font-extrabold text-bancolombia-text">F</span>
                </div>
                <span className="text-xl font-bold text-white group-hover:text-bancolombia-yellow transition-colors duration-300">FinUp</span>
              </Link>
            </div>
            ...
            <div className="ml-3 relative">
              <div className="flex items-center space-x-4">
                <div className="hidden md:flex items-center bg-bancolombia-blue-dark px-3 py-1.5 rounded-full">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-bancolombia-yellow mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
