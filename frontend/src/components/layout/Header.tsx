      ...
      <div className="w-full px-6">
        <div className="max-w-7xl mx-auto flex justify-between h-16 items-center">
          <div className="flex items-center">
            <Link
              href="/"
              className="text-neutral-dark text-xl font-bold flex items-center transition-transform duration-200 hover:scale-105"
            >
              ...
              {notificacionesAbiertas && (
                <div className="absolute right-0 mt-2 w-80 bg-white shadow-lg rounded-md p-4 border border-gray-200">
                  ...
                  <ul className="text-sm text-gray-700">
                    ...
                    <li className="border-b py-2">
                      ⚠️ La EVC 'Tech Solutions' ha gastado el 85% de su
                      presupuesto.
                    </li>
                    <li className="py-2">
