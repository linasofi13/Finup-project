...
export default function Card({
  ...
  return (
    ...
    >
      ...
      {title && (
        <div
          className={`px-4 py-5 sm:px-6 border-b relative z-10 ${variant === "primary" ? "border-primary/30 bg-primary/10" : variant === "secondary" ? "border-secondary/30 bg-secondary/10" : "border-neutral-medium bg-neutral-light"}`}
        >
          <h3 className="text-lg leading-6 font-medium text-neutral-dark">
            {title}
          </h3>
        </div>
      )}
